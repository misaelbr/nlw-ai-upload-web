        ...
        <aside className='w-80 space-y-6'>
          <form className='space-y-6'>
            ...
            <div className='space-y-2'>
              ...
              <Textarea
                id='transription_prompt'
                className='h-20 leading-relaxed resize-none '
                placeholder='Inclua palavras-chave mencionadas no vídeo separada por vírcula (,)'
              />
            </div>
          ...
          <div className='space-y-2'>
            ...
            <div className='space-y-2'>
              ...
              <Slider
                ...
                step={0.1}
              />
              <span className='block text-xs italic text-muted-foreground leading-relaxed space-y-4'>
